package com.gestureworks.cml.elements 
{
	...
	{		
		...
		{					
			...
			if (collectionViewer.testImg) {
				collectionViewer.testImg.close();
				collectionViewer.testImg.src = obj.image.src;
				collectionViewer.testImg.width = 0;
				collectionViewer.testImg.height = 0;
				collectionViewer.testImg.open();
				collectionViewer.testImg.scale = .5;
				collectionViewer.testImg.visible = true;
			}
